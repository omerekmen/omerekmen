...
<svelte:head>
	...
	<meta name="description" content="Connect with {personal.name} — social links, portfolio, CV, and contact." />
	<meta property="og:type" content="profile" />
	<meta property="og:url" content="https://www.omerekmen.com/s" />
	<meta property="og:title" content="Links — {personal.name}" />
	<meta property="og:description" content="All links for {personal.name} — Portfolio, GitHub, LinkedIn, Email, and CV." />
	...
	<div class="relative z-10 flex w-full max-w-[420px] flex-col items-center gap-6">
		...
		<div bind:this={linksEl} class="mt-2 flex w-full flex-col gap-3">
			{#each links as link (link.label)}
				...
				>
					<!-- Icon -->
					<span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-bg-tertiary/50 text-text-muted transition-colors duration-200 group-hover:bg-accent/10 group-hover:text-accent">
						{#if link.icon === 'globe'}
					...
					<!-- Arrow -->
					<svg class="h-4 w-4 text-text-muted transition-all duration-200 group-hover:translate-x-0.5 group-hover:text-accent" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
